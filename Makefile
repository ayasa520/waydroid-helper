...
install:
	...
	cp -a waydroid-helper.py service.py tools qml model bin $(INSTALL_HELPER_DIR)
...
uninstall:
	rm -rf $(INSTALL_BIN_DIR)/waydroid-helper $(INSTALL_DBUS_DIR)/system.d/com.waydroid.Helper.conf  $(INSTALL_POLKIT_DIR)/actions/com.waydroid.Helper.policy $(INSTALL_DBUS_DIR)/system-services/com.waydroid.Helper.service