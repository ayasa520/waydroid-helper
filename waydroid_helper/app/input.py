...
class AMontionEventAction(IntEnum):
    MASK = 0xFF
...
class AMontionEventFlags(IntEnum):
...
class AMontionEventAxis(IntEnum):
    X = 0
    Y = 1
    PRESSURE = 2
    SIZE = 3
...
class AMontionEventButtons(IntEnum):
    PRIMARY = 1 << 0
    SECONDARY = 1 << 1
    TERTIARY = 1 << 2
    BACK = 1 << 3
...
class AInputMotionRange(IntEnum):
    X = AMontionEventAxis.X
    Y = AMontionEventAxis.Y
    PRESSURE = AMontionEventAxis.PRESSURE
    SIZE = AMontionEventAxis.SIZE
    TOUCH_MAJOR = AMontionEventAxis.TOUCH_MAJOR
    TOUCH_MINOR = AMontionEventAxis.TOUCH_MINOR
    TOOL_MAJOR = AMontionEventAxis.TOOL_MAJOR
    TOOL_MINOR = AMontionEventAxis.TOOL_MINOR
    ORIENTATION = AMontionEventAxis.ORIENTATION
